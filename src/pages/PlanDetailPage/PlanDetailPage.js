  ...
  export default function PlanDetailPage() {
    ...
    const onHandleDragStart = useCallback(
      (e) => {
        ...
        window.addEventListener("mousemove", onDragMove, { passive: false, capture: true });
        window.addEventListener("mouseup", onDragEnd, { passive: false, capture: true });
        window.addEventListener("touchmove", onDragMove, { passive: false, capture: true });
        window.addEventListener("touchend", onDragEnd, { passive: false, capture: true });
      },
